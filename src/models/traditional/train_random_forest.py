...
class RandomForestTrainer:
    def __init__(self, config_path='configs'):
        ...
        self.models_dir = models_root / 'random_forest'
    ...
    def run(self, feature_type='acoustic'):
        ...
        # Нормализация (не обязательна для Random Forest, но для единообразия)
        ...
        metrics_path = self.metrics_dir / 'random_forest_metrics.json'
